...
class UpdateSubscriberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateSubscriber_request';
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UpdateSubscriberRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name The subscriber's first name.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UpdateSubscriberRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets lists
     *
     * @param string[]|null $lists An array of list IDs.  The subscriber will be removed from any lists not in this array.
     *
     * @return self
     */
