...
/**
 * CreateEnquiryForSubscriber200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEnquiryForSubscriber200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEnquiryForSubscriber_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'enquiry' => '\OpenAPI\Client\Model\Enquiry'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('enquiry', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['enquiry'];
    }

    /**
     * Sets enquiry
     *
     * @param \OpenAPI\Client\Model\Enquiry|null $enquiry enquiry
     *
     * @return self
     */
    ...
    {
        if (is_null($enquiry)) {
            throw new \InvalidArgumentException('non-nullable enquiry cannot be null');
        }
        $this->container['enquiry'] = $enquiry;
