...
/**
 * CreateOrUpdateSubscriberRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrUpdateSubscriberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createOrUpdateSubscriber_request';
    ...
    */
     ...
     * Sets email_address
     *
     * @param string $email_address The email address of the subscriber. This is required.
     *
     * @return self
     */
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling CreateOrUpdateSubscriberRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateOrUpdateSubscriberRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CreateOrUpdateSubscriberRequest., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param bool|null $marketing_consent Has the subscriber consented to marketing?  true or false will update the value, null or not passing the field at all will leave their existing consent alone.
     *
     * @return self
     */
     ...
     * Sets lists
     *
     * @param string[]|null $lists An array of list IDs.  An updated subscriber will be added to any lists here, but will not be removed from any of their existing lists.
     *
     * @return self
     */
