 ...
 */
class ApiUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiUser';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id A globally unique ID for this API user.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name for this API user.
     *
     * @return self
     */
