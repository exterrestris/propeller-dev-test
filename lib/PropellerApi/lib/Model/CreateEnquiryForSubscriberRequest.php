...
/**
 * CreateEnquiryForSubscriberRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEnquiryForSubscriberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEnquiryForSubscriber_request';
    ...
    */
     ...
     * Sets message
     *
     * @param string $message The message for the enquiry.
     *
     * @return self
     */
