...
/**
 * ApiFieldValidationError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiFieldValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiFieldValidationError';
    ...
    */
     ...
     * Sets field
     *
     * @param string|null $field The field with an error.
     *
     * @return self
     */
